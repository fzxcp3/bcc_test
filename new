...
if __name__ == '__main__':
    ...
    ebpf.attach_kprobe(event="tcp_v4_connect", fn_name="trace_connect_entry")
    ebpf.attach_kprobe(event="tcp_v6_connect", fn_name="trace_connect_entry")
    ebpf.attach_kretprobe(event="tcp_v4_connect", fn_name="trace_connect_v4_return")
    ebpf.attach_kretprobe(event="tcp_v6_connect", fn_name="trace_connect_v6_return")


    ebpf.attach_kprobe(event="do_sys_open", fn_name="open_trace_entry")
    ebpf.attach_kretprobe(event="do_sys_open", fn_name="open_trace_return")

    ebpf.attach_uprobe(name="c", sym="getaddrinfo", fn_name="dns_entry")
    ebpf.attach_uprobe(name="c", sym="gethostbyname", fn_name="dns_entry")
    ebpf.attach_uprobe(name="c", sym="gethostbyname2", fn_name="dns_entry")
